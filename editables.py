...
#Nom du profile account + Nom a montrer dans le game intro

health=int(input("Pour health ? (HP)")
invplace=int(input("Nombre de place dans l'inventaire ?")
#List de ce size la
cash=int(input("Quantite d'argent au debut du jeu ?"))
...
cashgainedbasic=int(input("Nombre d'argent gagne lorsqu'on tue un monstre simple ou en completant une quete simple ?"))
cashgainedunique=int(input("Nombre d'argent gagne lorsqu'on tue un monstre unique/boss ou en competant une quete epique ?"))
